...
const en = {
  ...
  'landing.pricing.footnote': 'Every plan includes the whole product — the boards, the documents, the whiteboard, the CLI and all thirteen themes. Plans change how much of it you can hold.',
...
const ptBR: Record<TranslationKey, string> = {
  ...
  'landing.pricing.footnote': 'Todos os planos incluem o produto inteiro — os quadros, os documentos, a lousa, a CLI e os treze temas. O plano muda o quanto você pode guardar.',
