# Graph Report - C:\Users\jorda\OneDrive\Documentos\GitHub\Task-Studio\Task-Studio-UI  (2026-08-25)

## Corpus Check
- 59 files · ~187,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1508 nodes · 2022 edges · 151 communities (103 shown, 48 thin omitted)
...
Cohesion: 0.06
Nodes (58): taskApi, blockingAssigneeCount(), canCompleteTask(), completionBlockedReason(), CompletionContext, completionProgress(), isSharedTask(), outstandingAssignees() (+50 more)
...
Cohesion: 0.07
Nodes (27): axios, date-fns, @dnd-kit/modifiers, @hookform/resolvers, lucide-react, dependencies, axios, date-fns (+19 more)
...
Cohesion: 0.14
Nodes (13): RFC-5321, BOARD_INK_COLORS, CONNECTOR_COLORS, EDGE_REVEAL_PX, MAX_BOARD_PAGES, NOTE_COLORS, STORAGE_KEYS, TASK_COLORS (+5 more)
...
### Community 102 - "Chat Pin (variant)"
Cohesion: 0.67
...
### Community 112 - "Floating Shortcut Layer"
Cohesion: 0.67
Nodes (3): RunicText(), RunicTextProps, seedOf()

### Community 113 - "Settings Page (variant)"
Cohesion: 0.67
Nodes (3): clamp(), ZoomableImage(), ZoomableImageProps

## Knowledge Gaps
- **465 isolated node(s):** `name`, `private`, `version`, `type`, `description` (+460 more)
...
- **Why does `dependencies` connect `UI Primitives Kit` to `Board Marquee Gestures`, `React Core Lib`, `Toast Notifications Lib`, `PWA Manifest Icons`, `Document Byline UI`, `PWA App Identity`, `Package Manifest`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `RouteBoundary` connect `Select Popup Component` to `Frontend Dependencies`, `Date Formatting Utils`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Node/Vite Build Config` to `Board Marquee Gestures`, `Package Manifest`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
