...
## Corpus Check
- 74 files · ~115,159 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1188 nodes · 1543 edges · 131 communities (77 shown, 54 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.55)
- Token cost: 44,597 input · 0 output
...
4. `GlyphSet` - 10 edges
5. `useProjectBoardCache()` - 10 edges
...
Cohesion: 0.06
Nodes (45): taskApi, blockingAssigneeCount(), canCompleteTask(), completionBlockedReason(), CompletionContext, completionProgress(), isSharedTask(), outstandingAssignees() (+37 more)
...
Cohesion: 0.06
Nodes (16): AuthScene(), DeskObject(), DeskObjectProps, floatTransition(), AuthShell(), AuthShellProps, Phase, api (+8 more)
...
Cohesion: 0.32
Nodes (5): aiApi, AiSuggestion, ProjectTaskSuggestion, SubtaskSuggestion, PRIORITY_STYLE
...
### Community 66 - "Env Config Resolution"
Cohesion: 0.50
...
### Community 83 - "Select Dropdown"
Cohesion: 0.50
Nodes (3): Select(), SelectOption, SelectProps

## Knowledge Gaps
- **373 isolated node(s):** `name`, `private`, `version`, `type`, `description` (+368 more)
...
- **Why does `dependencies` connect `Frontend Dependencies` to `PostCSS Build Config`, `date-fns Dependency`, `dnd-kit Sortable Dep`, `lucide-react Dependency`, `React Dependency`, `react-dom Dependency`, `react-hook-form Dependency`, `react-router-dom Dependency`, `socket.io-client Dependency`, `tailwind-merge Dependency`, `React Query Dependency`, `zod Dependency`, `Animation Dependencies`, `Architecture Principles (FSD)`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `PostCSS Build Config` to `Architecture Principles (FSD)`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `Rune glyph shapes used as visual/typographic reference for UI theme` connect `Runic Alphabet Reference` to `Runic Skin Icon Set`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
