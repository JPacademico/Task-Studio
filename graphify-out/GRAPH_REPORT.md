...
## Corpus Check
- 31 files · ~236,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1680 nodes · 2261 edges · 179 communities (120 shown, 59 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.53)
...
## Communities (179 total, 59 thin omitted)
...
Cohesion: 0.06
Nodes (35): App(), AppProviders(), QueryProvider(), NOTIFICATION_TOAST, RealtimeContext, RealtimeContextValue, RealtimeProvider(), roomHolders (+27 more)
...
Cohesion: 0.16
Nodes (18): ConvertedDocument, documentApi, useAdoptDocument(), useConvertDocument(), useCreateDocument(), useDeleteDocument(), useDocumentListCache(), useImportDocument() (+10 more)
...
### Community 48 - "Autumn Decor Elements"
Cohesion: 0.18
Nodes (9): FiltersVariant, LATENESS, PERSONAL_TABS, PersonalTab, PROJECT_SCOPES, STATUS_SWATCH, STATUSES, TaskFiltersProps (+1 more)

### Community 49 - "Text Board Editor"
Cohesion: 0.24
...
Cohesion: 0.33
Nodes (5): githubApi, RepositoryContributor, RepositoryImportPayload, RepositoryImportResult, RepositoryPreview
...
Cohesion: 0.36
Nodes (4): activityApi, ActivityEntry, ActivityPage, ActivityType
...
Cohesion: 0.33
Nodes (7): adminApi, adminTokenStore, client, AdminSession, AdminStats, AdminUserRow, BanPayload
...
Cohesion: 0.33
Nodes (4): CreateProjectDialogProps, Mode, GithubImportPanel(), GithubImportPanelProps
...
### Community 81 - "Runic Text (variant)"
Cohesion: 0.38
...
Cohesion: 0.33
Nodes (5): APPEARANCE, dayKey(), ProjectChangelog(), ProjectChangelogProps, SENTENCE
...
### Community 88 - "Personal Agenda Page"
Cohesion: 0.40
...
### Community 92 - "Colour Utilities"
Cohesion: 0.33
Nodes (3): Edge, KeepOut, Options

### Community 93 - "Skin Motion (variant)"
Cohesion: 0.33
...
### Community 96 - "Runic Decor Elements"
Cohesion: 0.47
...
### Community 104 - "Chat Pin (variant)"
Cohesion: 0.50
...
### Community 116 - "Pending Tasks Widget"
Cohesion: 0.67
Nodes (3): escapeText(), MAX_PLAIN_TEXT_CHARS, plainTextToHtml()

### Community 118 - "Tear-off Ghost UI"
Cohesion: 0.67
...
### Community 124 - "Task Detail Modal"
Cohesion: 0.67
...
### Community 129 - "Volcano Decor Elements"
Cohesion: 0.67
Nodes (3): clamp(), ZoomableImage(), ZoomableImageProps

### Community 134 - "DnD Utilities Lib"
Cohesion: 1.00
...
## Knowledge Gaps
- **517 isolated node(s):** `name`, `private`, `version`, `type`, `description` (+512 more)
...
- **Why does `dependencies` connect `Board & Task Constants` to `Image Prep Utils`, `Eldritch Skin Icons`, `Skin Picker UI`, `UI Primitives Kit`, `UI Primitives Kit`, `Maskable App Icon`, `Project Dashboard Widget`, `Tailwind Config`, `Vite Deploy Assert`, `PostCSS Config`, `Maskable Icon Asset`, `CSS Theme Variables`, `Maskable Icon Asset`, `CSS Theme Variables`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `AppProviders()` connect `Auth Desk Scene` to `Icon Generation Script`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `installApiWarmOnIntent()` connect `Icon Generation Script` to `Auth Desk Scene`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
